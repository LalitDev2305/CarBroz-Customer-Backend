...
export interface ISduiRegistryRepository {
    ...
    registerSubcomponent(name: string, componentType: string, schemaJson: any, supportedProperties?: any, supportedActions?: any): Promise<SduiSubcomponentEntity>;
    getSubcomponent(name: string): Promise<SduiSubcomponentEntity | null>;
    listSubcomponents(): Promise<SduiSubcomponentEntity[]>;
    registerChild(name: string, componentType: string, schemaJson: any, supportedProperties?: any, supportedActions?: any): Promise<SduiChildEntity>;
    getChild(name: string): Promise<SduiChildEntity | null>;
    listChildren(): Promise<SduiChildEntity[]>;
    registerChildrenData(name: string, componentType: string, schemaJson: any, supportedProperties?: any, supportedActions?: any): Promise<SduiChildrenDataEntity>;
