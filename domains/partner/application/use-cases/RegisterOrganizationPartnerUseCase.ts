...
export interface RegisterOrganizationPartnerResult {
  partner: Partner;
  member: PartnerMember;
}

export class RegisterOrganizationPartnerUseCase implements IUseCase<
  RegisterOrganizationPartnerInput,
  RegisterOrganizationPartnerResult
> {
  constructor(
  ...
  async execute({
    context,
    data,
  }: RegisterOrganizationPartnerInput): Promise<RegisterOrganizationPartnerResult> {
