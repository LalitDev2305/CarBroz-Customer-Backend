...
import { type IAddressRepository, type ICustomerProfileRepository, type IVehicleRepository } from '@carbroz/domain-customer';
import { type ICatalogRepository, type IPricingRepository, ServiceAddon } from '@carbroz/domain-catalog-pricing';
