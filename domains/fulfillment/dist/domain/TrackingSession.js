...
export class TrackingSession {
    ...
    constructor(props) {
        if (!props.bookingId)
            throw new Error('TrackingSession must be associated with a booking');
        if (!props.partnerId)
            throw new Error('TrackingSession must be associated with a partner');
        if (!props.customerId)
            throw new Error('TrackingSession must be associated with a customer');
    ...
    updateLocation(ping, etaMinutes) {
...
//# sourceMappingURL=TrackingSession.js.map