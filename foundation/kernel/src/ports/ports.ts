...
export interface IConfigRepository {
  findByKey(key: string): Promise<{ key: string; value: any } | null>;
  findAll(): Promise<Array<{ key: string; value: any }>>;
}
...
export interface IFeatureFlagRepository {
  findByKey(key: string): Promise<{ key: string; enabled: boolean } | null>;
  findAllFlags(): Promise<Array<{ key: string; enabled: boolean }>>;
}
