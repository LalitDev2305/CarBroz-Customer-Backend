...
function getController(): AdminSduiController {
  return new AdminSduiController(
    diContainer.resolve('registerSduiComponentUseCase'),
    ...
    diContainer.resolve('registerSduiSubcomponentUseCase'),
    diContainer.resolve('registerSduiChildUseCase'),
    diContainer.resolve('registerSduiChildrenDataUseCase')
  );
}
