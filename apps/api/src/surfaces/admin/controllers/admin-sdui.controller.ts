...
} from '../../../transport/sdui/dto/sdui-registry.dto.js';
...
export class AdminSduiController {
  ...
  public registerComponent = async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    const result = await this.createSduiComponentUseCase.execute({ context: toExecutionContext(request), data: dto });
  ...
  public registerSection = async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    const result = await this.createSduiSectionUseCase.execute({ context: toExecutionContext(request), data: dto });
  ...
  public registerGroup = async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    const result = await this.createSduiGroupUseCase.execute({ context: toExecutionContext(request), data: dto });
  ...
  public registerElement = async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    const result = await this.createSduiElementUseCase.execute({ context: toExecutionContext(request), data: dto });
  ...
  public createDraft = async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    const result = await this.createSduiDraftUseCase.execute({ context: toExecutionContext(request), data: dto });
  ...
  public updateDraft = async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    const result = await this.updateSduiDraftUseCase.execute({ context: toExecutionContext(request), data: dto });
  ...
  public publishVersion = async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    const result = await this.publishSduiVersionUseCase.execute({ context: toExecutionContext(request), data: dto });
  ...
  public archiveVersion = async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    const result = await this.archiveSduiVersionUseCase.execute({ context: toExecutionContext(request), data: dto });
  ...
  public rollbackVersion = async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    const result = await this.rollbackSduiVersionUseCase.execute({ context: toExecutionContext(request), data: dto });
  ...
  public getVersionHistory = async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    const result = await this.getSduiVersionHistoryUseCase.execute({ screenId, targetApp: parseTargetApp(targetApp) });
  ...
  public getSpecificVersion = async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    const { targetApp } = request.query as { targetApp?: unknown };
    const result = await this.getSduiSpecificVersionUseCase.execute({ screenId, targetApp: parseTargetApp(targetApp), versionNumber: parseInt(versionNumber, 10) });
  ...
  public compareVersions = async (request: FastifyRequest, reply: FastifyReply) => {
    const { screenId } = request.params as { screenId: string };
    const { targetApp, sourceVersion, targetVersion } = request.query as { targetApp?: unknown; sourceVersion: string; targetVersion: string };
    const dto = compareSduiVersionsSchema.parse({ screenId, targetApp: parseTargetApp(targetApp), sourceVersion: parseInt(sourceVersion, 10), targetVersion: parseInt(targetVersion, 10) });
