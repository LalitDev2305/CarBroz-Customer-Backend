...
import { z } from 'zod';
import { createCategorySchema, createServiceSchema, createAddonSchema, createPricingTierSchema, setVehicleMultiplierSchema } from '../customer/catalog/dto/catalog.dto.js';
