...
import { createVehicleSchema } from '../dto/vehicle.vehicle.dto.js';

/** VehicleController is an exported apps/api contract/implementation; see the owning README for lifecycle and extension rules. */
