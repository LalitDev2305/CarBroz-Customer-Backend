...
/**
 * Partner Login SDUI composition.
 *
 * This file contains presentation data only. Authentication behavior is intentionally absent;
 * the Continue action can be bound to Identity later without changing the structural UI contract.
 */
        ...
        },
        {
          ...
          sections: [
              ...
              groups: [
                {
                  ...
                  elements: [
                    ...
                    },
                    {
                      ...
                      properties: { fieldId: 'mobileNumber', placeholder: '98765 43210', keyboardType: 'phone', maxLength: 10, required: true, weight: 1 },
                      validation: { pattern: '^[6-9][0-9]{9}$', message: 'Enter a valid 10-digit mobile number' },
                    },
                  ],
                },
              ],
            },
            {
              ...
              elements: [
                {
                  id: 'continue_button', type: 'button', properties: {
