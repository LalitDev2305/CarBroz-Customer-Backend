...
import { SendOtpSchema, VerifyOtpSchema, GuestLoginSchema, RefreshTokenSchema, LogoutSchema } from './dto/auth.dto.js';
...
/** AuthController is an exported apps/api contract/implementation; see the owning README for lifecycle and extension rules. */
