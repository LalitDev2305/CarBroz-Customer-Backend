import { ICorporateMemberRepository, CorporateMemberRole } from '@carbroz/domain-enterprise';
import { FastifyRequest, FastifyReply } from 'fastify';


/** createCorporateAuthMiddleware is an exported apps/api contract/implementation; see the owning README for lifecycle and extension rules. */
...
/** requireCorporateRole is an exported apps/api contract/implementation; see the owning README for lifecycle and extension rules. */
