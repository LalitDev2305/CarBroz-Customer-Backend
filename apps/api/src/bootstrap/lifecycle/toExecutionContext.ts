 ...
 *
 * This is an API bootstrap/lifecycle concern: domains receive correlation/actor/time metadata only
 * and never Fastify requests, JWT payloads or transitional request-context contracts.
 */
