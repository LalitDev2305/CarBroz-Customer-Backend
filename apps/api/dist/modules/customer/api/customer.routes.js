...
export default async function customerRoutes(fastify) {
    const customerController = new CustomerController(diContainer.resolve('getCustomerProfileUseCase'), diContainer.resolve('updateCustomerProfileUseCase'), diContainer.resolve('manageAddressUseCase'), diContainer.resolve('extractCustomerDataUseCase'));
