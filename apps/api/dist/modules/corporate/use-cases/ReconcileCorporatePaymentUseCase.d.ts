import { ICorporateAccountRepository, ICorporateInvoiceRepository, ICorporateCreditLedgerRepository, AuditLogService } from '@carbroz/foundation-kernel';
...
export declare class ReconcileCorporatePaymentUseCase {
    ...
    execute(dto: ReconcileCorporatePaymentDto, adminUserId: number): Promise<any>;
}
