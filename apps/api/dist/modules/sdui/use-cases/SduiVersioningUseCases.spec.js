...
import { SduiScreenEntity, ForbiddenError, NotFoundError } from '@carbroz/foundation-kernel';
describe('Phase 14 — SDUI Versioning UseCases', () => {
    let repository;
    const adminContext = { authenticatedUser: { id: 1, isAdmin: true } };
    const userContext = { authenticatedUser: { id: 2, isAdmin: false } };
    ...
    describe('CompareSduiVersionsUseCase', () => {
        it('should compare source and target versions', async () => {
            ...
            repository.getSpecificVersion.mockImplementation((sId, tApp, vNum) => {
                if (vNum === 1)
                    return Promise.resolve(mockV1);
                if (vNum === 2)
                    return Promise.resolve(mockV2);
...
//# sourceMappingURL=SduiVersioningUseCases.spec.js.map