import { Invoice, Money, TaxCalculator, DEFAULT_FINANCIAL_CONFIG, } from '@carbroz/foundation-kernel';
export class GenerateInvoiceUseCase {
    invoiceRepository;
    bookingRepository;
    taxCalculator;
    constructor(invoiceRepository, bookingRepository, taxCalculator = new TaxCalculator()) {
