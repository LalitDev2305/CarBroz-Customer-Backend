...
export default async function adminCatalogRoutes(fastify) {
    const controller = new AdminCatalogController(diContainer.resolve('manageCatalogUseCase'), diContainer.resolve('managePricingTierUseCase'));
...
//# sourceMappingURL=admin-catalog.routes.js.map