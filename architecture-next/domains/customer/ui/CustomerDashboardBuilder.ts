import { IScreen, UITheme, BaseTemplate, UI, BaseScreenBuilder, GenericComponent, BuildContext } from '@carbroz/sdui-engine';

export class CustomerDashboardBuilder extends BaseScreenBuilder {

  public readonly screenId = 'home';
  ...
  private buildHeader(isLoggedIn: boolean): GenericComponent {
    ...
    leftChild.addChildData(
      UI.component('header_location_avatar', 'atom_avatar')
        .setProperties({
          icon: {
    ...
    textLayout.addChildData(
      UI.component('header_location_title', 'atom_text')
        .setProperties({
          text: 'Work',
          textColor: '#000000',
    ...
    textLayout.addChildData(
      UI.component('header_location_subtitle', 'atom_text')
        .setProperties({
          text: 'HSR Layout',
          textColor: '#666666',
    ...
    if (isLoggedIn) {
      rightChild.addChildData(
        UI.component('header_profile_avatar', 'atom_avatar')
          .setProperties({
            icon: {
              iconName: 'ic_user',
      ...
      rightChild.addChildData(
        UI.component('header_login_btn', 'atom_button')
          .setProperties({
            text: 'Login',
  ...
  private buildSearchBox(): GenericComponent {
    ...
    searchChild.addChildData(
      UI.component('search_input_atom', 'atom_input_field')
        .setProperties({
          inputType: 'text',
    ...
    searchChild.addChildData(
      UI.component('search_filter_avatar', 'atom_avatar')
        .setProperties({
          icon: {
            iconName: 'ic_filter',
            imageUrl: '',
  ...
  private buildHeroBanner(): GenericComponent {
    ...
    textChild.addChildData(
      UI.component('hero_badge_atom', 'atom_badge')
        .setProperties({
    ...
    textChild.addChildData(
      UI.component('hero_title_atom', 'atom_text')
        .setProperties({
    ...
    textChild.addChildData(
      UI.component('hero_book_btn_atom', 'atom_button')
        .setProperties({
          text: 'Book Now',
    ...
    imageChild.addChildData(
      UI.component('hero_car_image_atom', 'atom_image')
        .setProperties({
  ...
  private buildServicesCard(): GenericComponent {
    ...
    const addServiceItem = (id: string, name: string, icon: string) => {
      ...
      child.addChildData(
        UI.component(`service_${id}_avatar`, 'atom_avatar')
          .setProperties({
      ...
      child.addChildData(
        UI.component(`service_${id}_text`, 'atom_text')
          .setProperties({
            text: name,
            textColor: '#111111',
    ...
    arrowChild.addChildData(
      UI.component('service_arrow_avatar', 'atom_avatar')
        .setProperties({
