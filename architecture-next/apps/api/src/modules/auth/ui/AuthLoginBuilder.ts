import { IScreen, UITheme, BaseTemplate, UI, BaseScreenBuilder, BuildContext } from '@carbroz/ui-sdk';
...
export class AuthLoginBuilder extends BaseScreenBuilder {
  ...
  public async build(context?: BuildContext): Promise<IScreen> {
    ...
    topSection.addChildData(
      UI.component('login_logo_atom', 'atom_image')
        .setProperties({
    ...
    topSection.addChildData(
      UI.component('login_tagline_atom', 'atom_text')
        .setProperties({
    ...
    topSection.addChildData(
      UI.component('login_circle_icon_atom', 'atom_avatar')
        .setProperties({
          icon: {
           iconName: 'ic_user',
            imageUrl: '',
    ...
    topSection.addChildData(
      UI.component('login_welcome_atom', 'atom_text')
        .setProperties({
          text: 'Welcome Back!',
          textColor: '#000000',
          fontSize: 24,
    ...
    topSection.addChildData(
      UI.component('login_subtitle_atom', 'atom_text')
        .setProperties({
    ...
    topSection.addChildData(
      UI.component('phoneNumber', 'atom_input_field')
        .setProperties({
          inputType: 'phone',
          hint: 'Phone Number',
    ...
    topSection.addChildData(
      UI.component('login_get_otp_btn', 'atom_button')
        .setProperties({
          text: 'Continue',
    ...
    bottomSection.addChildData(
      UI.component('login_bottom_image_atom', 'atom_image')
        .setProperties({
