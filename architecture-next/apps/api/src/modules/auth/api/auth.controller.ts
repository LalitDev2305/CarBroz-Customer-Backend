...
import { SendOtpUseCase } from '../use-cases/SendOtpUseCase.js';
import { VerifyOtpUseCase } from '../use-cases/VerifyOtpUseCase.js';
import { GuestLoginUseCase } from '../use-cases/GuestLoginUseCase.js';
...
export class AuthController {
  ...
  public async me(request: FastifyRequest, reply: FastifyReply) {
    ...
    const userRepository = request.diScope.resolve<import('@carbroz/common').IUserRepository>('userRepository');
