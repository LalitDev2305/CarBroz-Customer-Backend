...
/** SduiComponentProps is an exported sdui/registry contract/implementation; see the owning README for lifecycle and extension rules. */
...
/** SduiComponentEntity is an exported sdui/registry contract/implementation; see the owning README for lifecycle and extension rules. */
...
/** SduiComponentRegistryProps is an exported sdui/registry contract/implementation; see the owning README for lifecycle and extension rules. */
export type SduiComponentRegistryProps = SduiComponentProps;
/** SduiComponentRegistryEntity is an exported sdui/registry contract/implementation; see the owning README for lifecycle and extension rules. */
